...
elsoc <- elsoc %>%
  ...
  mutate(
    ...
    # Interview
    ciuo08_m03_w01 = if_else(
      is.na(ciuo08_m03_w01) & m02_w01 == 5,
      15000,
      ciuo08_m03_w01
    ), # retired
    ciuo08_m03_w01 = if_else(
      is.na(ciuo08_m03_w01) & m02_w01 == 6,
      16000,
      ciuo08_m03_w01
    ), # unemployed
    ciuo08_m03_w04 = if_else(
      is.na(ciuo08_m03_w04) & m02_w04 == 5,
      15000,
      ciuo08_m03_w04
    ),
    ciuo08_m03_w04 = if_else(
      is.na(ciuo08_m03_w04) & m02_w04 == 6,
      16000,
      ciuo08_m03_w04
    ),
    ciuo08_m03_w06 = if_else(
      is.na(ciuo08_m03_w06) & m02_w06 == 5,
      15000,
      ciuo08_m03_w06
    ),
    ciuo08_m03_w06 = if_else(
      is.na(ciuo08_m03_w06) & m02_w06 == 6,
      16000,
      ciuo08_m03_w06
    ),
    # Household sostainer
    ciuo08_m22_w01 = if_else(
      is.na(ciuo08_m22_w01) & m02_w01 == 5,
      15000,
      ciuo08_m22_w01
    ), # retired
    ciuo08_m22_w01 = if_else(
      is.na(ciuo08_m22_w01) & m02_w01 == 6,
      16000,
      ciuo08_m22_w01
    ), # unemployed
    ciuo08_m22_w04 = if_else(
      is.na(ciuo08_m22_w04) & m02_w04 == 5,
      15000,
      ciuo08_m22_w04
    ),
    ciuo08_m22_w04 = if_else(
      is.na(ciuo08_m22_w04) & m02_w04 == 6,
      16000,
      ciuo08_m22_w04
    ),
    ciuo08_m22_w06 = if_else(
      is.na(ciuo08_m22_w06) & m02_w06 == 5,
      15000,
      ciuo08_m22_w06
    ),
    ciuo08_m22_w06 = if_else(
      is.na(ciuo08_m22_w06) & m02_w06 == 6,
      16000,
      ciuo08_m22_w06
    )
  )
...
elsoc <- elsoc %>%
  ...
  mutate(
    ...
    # assign household head occupation to inactive
    # (student, domestic, disability, nini)
    ciuo08_m03_w01 = coalesce(ciuo08_m03_w01, ciuo08_m22_w01),
    # assign individual occupation of wave 3 to inactive at wave 1
    #  (student, domestic, disability, nini)
    ciuo08_m03_w01 = coalesce(ciuo08_m03_w01, ciuo08_m03_w03),
    # assign household head occupation of wave 3 to inactive at wave 1
    #  (student, domestic, disability, nini)
    ciuo08_m03_w01 = coalesce(ciuo08_m03_w01, ciuo08_m22_w03),
    # assign individual occupation of wave 5 to inactive at wave 1
    #  (student, domestic, disability, nini)
    ciuo08_m03_w01 = coalesce(ciuo08_m03_w01, ciuo08_m03_w05),
    # assign household head occupation of wave 5 to inactive at wave 1 (student, domestic, disability, nini)
