...
m29_nas <- map(
  paste0("m29_w0", c(1, 4, 6)),
  ~ check_m29(var = .x, moment = "original")
)
...
m29_nas[[1]] <- m29_nas[[1]] %>%
  mutate(
    m29_w01_old_imputation = test %>%
      filter(idencuesta %in% m29_nas[[1]]$idencuesta) %>%
      pull(m29_w01)
  )
m29_nas[[2]] <- m29_nas[[2]] %>%
  mutate(
    m29_w04_old_imputation = test %>%
      filter(idencuesta %in% m29_nas[[2]]$idencuesta) %>%
      pull(m29_w04)
  )
m29_nas[[3]] <- m29_nas[[3]] %>%
  mutate(
    m29_w06_old_imputation = test %>%
      filter(idencuesta %in% m29_nas[[3]]$idencuesta) %>%
      pull(m29_w06)
  )
...
m29_nas[[1]] <- m29_nas[[1]] %>%
  mutate(
    m29_w01_new_imputation = test2 %>%
      filter(idencuesta %in% m29_nas[[1]]$idencuesta) %>%
      pull(m29_w01)
  )
m29_nas[[2]] <- m29_nas[[2]] %>%
  mutate(
    m29_w04_new_imputation = test2 %>%
      filter(idencuesta %in% m29_nas[[2]]$idencuesta) %>%
      pull(m29_w04)
  )
m29_nas[[3]] <- m29_nas[[3]] %>%
  mutate(
    m29_w06_new_imputation = test2 %>%
      filter(idencuesta %in% m29_nas[[3]]$idencuesta) %>%
      pull(m29_w06)
  )
