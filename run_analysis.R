...
source("analysis/main/4_mult_analysis_z_sin_stgo.R", encoding = "UTF-8")
source("analysis/main/5_sig-coef_z.R", encoding = "UTF-8")
source("analysis/main/6_desc_analysis.R", encoding = "UTF-8")
source("analysis/main/7_plot-coef2_z.R", encoding = "UTF-8")
source("analysis/main/8_plot-preds2_z_nse_cat.R", encoding = "UTF-8")
...
quarto::quarto_render("output/reports/main/mult_analysis_z_sin_stgo.qmd")
